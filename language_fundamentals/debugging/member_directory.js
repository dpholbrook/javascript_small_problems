...
/*
Our regex is: start of string, one or more alpha chars, space, one or mor alpha chars, end of string

Her regex used 'word chars' instead of alpha chars. Word chars include 0-9 which we dont want
