...
/*
The arguments object is not an array so we can only treat it like one to get the length and a value at a specific index. But, if we want to interate on it, we need to convert it to an array. The rest syntax is the easiest way to do this.
*/