...
// In order to sort an array of numbers, we must pass a callback function to the sort method which combares the numeric values. If we just call sort() it treats the numbers like strings (their char values)