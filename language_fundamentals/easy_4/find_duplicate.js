...
//output: number
//
//rules: return the value that occurs twice
//
//algorithm:
//  - iterate throught the array keeping track of the current index
//  - if the last index of the current element does not equal the current index, return current element
//
